...
<head>
  ...
  <link href="/template-user/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="/template-user/assets/vendor/quill/quill.snow.css" rel="stylesheet">
  <link href="/template-user/assets/vendor/quill/quill.bubble.css" rel="stylesheet">
  <link href="/template-user/assets/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="/template-user/assets/vendor/simple-datatables/style.css" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="/template-user/assets/css/style.css" rel="stylesheet">
...
<body>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">E-SISTEM UJIAN ONLINE</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Masukan data diri anda dalam membuat akun</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" action="{{route('register-post')}}" method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="nama" class="form-control @error('nama')is-invalid @enderror" id="yournama">
                      @error('nama') 
  ...
  <script src="/template-user/assets/vendor/chart.js/chart.umd.js"></script>
  <script src="/template-user/assets/vendor/echarts/echarts.min.js"></script>
  <script src="/template-user/assets/vendor/quill/quill.min.js"></script>
  <script src="/template-user/assets/vendor/simple-datatables/simple-datatables.js"></script>
  <script src="/template-user/assets/vendor/tinymce/tinymce.min.js"></script>
